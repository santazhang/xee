...
#ifndef PDFNameCollisionPreventer_h
#define PDFNameCollisionPreventer_h
...
#define PDFNoAlgorithm XeePDFNoAlgorithm
#define PDFStandardAlgorithm XeePDFStandardAlgorithm
