...
@class XeeCollisionPanel, XeeRenamePanel, XeePasswordPanel, XeeStatusBar,
	XeeDestinationView;
@class XeeMoveTool, XeeCropTool;

@interface XeeController
	: NSObject <XeeImageSourceDelegate, NSToolbarDelegate, NSWindowDelegate> {
...
- (void)xeeImageSource:(XeeImageSource *)msgsource
		imageDidChange:(XeeImage *)image;
...
@property (nonatomic, getter=isResizeBlocked, setter=setResizeBlock:)
	BOOL resizeBlocked;
- (NSSize)maxViewSize;
- (NSSize)minViewSize;
...
- (void)detachBackgroundTaskWithMessage:(NSString *)message
