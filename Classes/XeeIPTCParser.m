...
- (id)initWithHandle:(CSHandle *)handle
{
	if (self = [super init]) {
		...
		@catch (id e) {
			NSLog(@"Error parsing IPTC metadata: %@", e);
		}
	}
	return self;
}
	...
	switch (record) {
		...
		case 2:
			switch (dataset) {
				...
				case 4:
					*type = XeeIPTCString;
					return @"Object attribute reference";
				case 5:
					*type = XeeIPTCString;
					return @"Object name";
				case 7:
				...
				case 151:
					*type = XeeIPTCString;
					return @"Audio sampling ate";
				case 152:
					*type = XeeIPTCString;
					return @"Audio sampling resolution";
				case 153:
					*type = XeeIPTCString;
